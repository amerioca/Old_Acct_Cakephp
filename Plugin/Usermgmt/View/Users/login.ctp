		...
		<div class="um_box_mid_content">
			...
			<div class="um_box_mid_content_mid" id="login">
				<div class="um_box_mid_content_mid_left">
					...
					<div>
						<div class="umstyle3"><?php echo __('Email / Phone Number');?></div>
						<div class="umstyle4" ><?php echo $this->Form->input("username" ,array('label' => false,'div' => false,'class'=>"umstyle5", 'id'=> 'PhoneNumber' ))?></div>

...
8b544fb6a852f1dde0f4cc87b4342df8
89911518ccaaec29112c20f4b1fd01e7
*/
function UsermgmtInIt(&$controller) {
	...
	*/
	if(!defined("EMAIL_FROM_ADDRESS")) {
		define("EMAIL_FROM_ADDRESS", 'site@trap190.com');
	}
	...
	*/
	if(!defined("EMAIL_FROM_NAME")) {
		define("EMAIL_FROM_NAME", 'Club Trap 190');
	}

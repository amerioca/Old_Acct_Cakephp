...
<?php echo $this->Form->create('ItemsInventory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Items Inventory'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ItemsInventory.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ItemsInventory.id'))); ?></li>

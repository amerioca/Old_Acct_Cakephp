<div class="itemsInventories index">
	<h2><?php echo __('Items Inventories'); ?></h2>
	...
	<tbody>
	<?php foreach ($itemsInventories as $itemsInventory): ?>
	<tr>
		<td><?php echo h($itemsInventory['ItemsInventory']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $itemsInventory['ItemsInventory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $itemsInventory['ItemsInventory']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $itemsInventory['ItemsInventory']['id']), array(), __('Are you sure you want to delete # %s?', $itemsInventory['ItemsInventory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

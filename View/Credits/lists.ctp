<div class="credits list"><?php //debug($credits);?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <?php echo $this->Html->link($credit['User']['first_name'], array('controller' => 'users', 'action' => 'view', $credit['User']['id'])); ?>
            </td>
            <td><?php echo h($credit['Credit']['amount']); ?>&nbsp;</td>
            <td>
                <?php echo $this->Html->link($credit['CreditType']['type'], array('controller' => 'credit_types', 'action' => 'view', $credit['CreditType']['id'])); ?>
            </td>
            <td>
                <?php echo $this->Html->link($credit['Promoter']['first_name'].' '.$credit['Promoter']['last_name'], array('controller' => 'promoters', 'action' => 'view', $credit['Promoter']['id'])); ?>
            </td>
            <td>
                <?php echo $this->Html->link($credit['AdminCredit']['first_name'].' '.$credit['AdminCredit']['last_name'], array('controller' => 'admin_credits', 'action' => 'view', $credit['AdminCredit']['id'])); ?>
            </td>

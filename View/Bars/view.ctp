...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Bar'), array('action' => 'delete', $bar['Bar']['id']), array(), __('Are you sure you want to delete # %s?', $bar['Bar']['id'])); ?> </li>
	</ul>
</div>
<?php echo $this->element('sidebar'); ?>
	...
	<?php foreach ($bar['Order'] as $order): ?>
		<tr>

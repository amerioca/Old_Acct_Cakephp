<div class="Customers List"><?php //debug($customers);?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td><?php echo $customer['User']['first_name'], ' '.$customer['User']['last_name']; ?>&nbsp;</td>
            <td><?php echo h($customer['User']['user_group_id']); ?>&nbsp;</td>
            ...
            <td class="actions">
                <?php echo $this->Html->link(__('View'), array('action' => 'view', $customer['User']['id'])); ?>
                <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $customer['User']['id'])); ?>
                <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $customer['User']['id']), array(), __('Are you sure you want to delete # %s?', $customer['User']['id'])); ?>
            </td>
        </tr>
            <?php endforeach; ?>
        </tbody>
